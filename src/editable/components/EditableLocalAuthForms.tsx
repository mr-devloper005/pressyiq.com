...
const inputClass = 'h-[3.25rem] rounded-xl border border-[var(--slot4-line)] bg-white px-4 text-base font-semibold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-soft-muted-text)] focus:border-[var(--slot4-accent)] focus:ring-2 focus:ring-[var(--slot4-accent)]/40'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-full bg-[var(--slot4-accent)] px-6 text-sm font-bold tracking-[-0.01em] text-black transition duration-300 hover:-translate-y-0.5 hover:bg-[var(--slot4-accent-3)] disabled:opacity-60'
